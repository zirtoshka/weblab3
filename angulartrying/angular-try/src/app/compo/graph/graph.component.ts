...
export class GraphComponent {
    ...
    createLabelsR(r: number) {
        if (r > 0.5) {
            ...
            if (r >= 1.5) {
                this.board.create('text', [this.r / 2 -0.25, 0 + this.rLabel, 'R/2'], {fixed: true, color: '#000000', fontSize: 11});
                this.board.create('text', [0 + 0.1, this.r / 2, 'R/2'], {fixed: true, color: '#000000', fontSize: 11});

                this.board.create('text', [-this.r / 2 -0.3, 0 + this.rLabel, '-R/2'], {fixed: true, color: '#000000', fontSize: 11});
                this.board.create('text', [0 + 0.1, -this.r / 2, '-R/2'], {fixed: true, color: '#000000', fontSize: 11});
            }
        }
